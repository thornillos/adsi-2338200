        ...
        <header class="bg-blue-900 py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                <nav class="space-x-4 text-gray-300 text-sm sm:text-base flex items-center">
                    @guest
                    <div class="select-lang flex gap-1">
                        <a href="{{ url('lang/en')}}">
                            <img src="{{ asset('images/en.png')}}" class="rounded-full p-1 bg-black/50 hover:scale-110 hover:bg-black/70 transition  @if(session()->get('locale') =='es') opacity-100 @else opacity-50 @endif">
                        </a>
                        <a href="{{ url('lang/es')}}">
