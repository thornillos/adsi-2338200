        ...
        <section class="bg-black
            ...
            <form action="" method="post" class="m-4 
                ...
                <label for="num_rows" class="flex justify-between w-[220px]">
                    ...
                    <input type="number" id="num_rows" name="num_rows" min="1" max="40" class="text-black p-1 rounded w-16" required>
                </label>
                <label for="num_cols" class="flex justify-between w-[220px]">
                    <strong>Number of Rows</strong>
                    <input type="number" id="num_cols" name="num_cols" min="1" max="20" class="text-black p-1 rounded w-16" required>
                </label>
                <button class="bg-indigo-200 py-2 px-4 text-black rounded"> Render Table</button>
            </form>
            <?php
                class RenderTable {
                    private $nr;
                    ...
                    private function renderTableBody() {
                        for ($i= 1; $i < $this->nr ; $i++) { 
                            echo'<tr>';
                            for ($j= 1; $j < $this->nc ; $j++) { 
                                echo '<td class="p-1 ring-1 ring-lime-100">'.$i.'c'.$j.'</td>';
                            }
                            echo'</tr>';
                        }
                    }
