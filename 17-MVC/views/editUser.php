            ...
            <section>
                ...
                <table class="mt-6 w-6/12 mx-auto border-collapse">
                    <tbody>
                        ...
                        <form action="?method=update&id=<?=$row['id']?>" method="POST" enctype="multipart/form-data">
                            <tr>
                                <td class="p-2 flex justify-center items-center">
                                    <img src="public/img/<?= $row['photo']?>" alt="sinFoto" class="w-[250px] rounded-full mx-[100px]">
                                </td>
                            </tr>
                            <tr class="bg-white/30 odd:bg-white/20 text-justify">
                                <td class="p-2">Imagen de perfil:</td>
                                <td class="p-2">
                            ...
                            <tr class="bg-white/30 odd:bg-white/20 text-justify">
                                ...
                                <td><input type="text" value="<?= $row['fullname']?>" name="fullname"></td>
                            </tr>
                            <tr class="bg-white/30 odd:bg-white/20 text-justify">
                                <td>Email: </td>
                            ...
                            <tr>
                                <td><input class="p-1 ring-1 ring-black bg-white/70 rounded-md my-1 hover:scale-105 hover:bg-white/90 hover:cursor-pointer" type="submit" value="ACTUALIZAR"></td>
                            </tr>
                        </form>
                        <?php endwhile?>
                        </tbody>
